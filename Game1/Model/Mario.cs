...
namespace Game1.Model
{
    public class Mario
    {
        ...
        public const int MARIO_INITIAL_Y_POSITION = 330;
        public const int MARIO_JUMP_SIZE = 250;

        public Mario()
        {
            this.Life = 1;
            this.Position = new Point(0, MARIO_INITIAL_Y_POSITION);
            this.Person = new Rectangle(0, MARIO_INITIAL_Y_POSITION, 48, 92);
        ...
        public void Jump()
        {
            ...
            {
                Person.Y += 3;
                if (Person.Y == MARIO_INITIAL_Y_POSITION)
                {
                    IsJump = false;
                    HighJump = false;
                }
